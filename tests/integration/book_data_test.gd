...
const BOOK_WRITER_SCENE := preload("res://tools/authoring/book_writer.tscn")
...
func _run() -> void:
	...
	(writer.get_node("%RightRuneLineEdit") as LineEdit).text = "res://content/runes/templates/bolt/bolt_template_02.tres"
