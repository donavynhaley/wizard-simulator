...
const BookDataResource := preload("res://game/books/resources/book_data.gd")
const BookPageDataResource := preload("res://game/books/resources/book_page_data.gd")
const BookSpreadDataResource := preload("res://game/books/resources/book_spread_data.gd")
const BOOK_SCENE := preload("res://game/books/book.tscn")

@export_dir var output_directory: String = "res://content/books"
@export var default_save_path: String = "res://content/books/new_book.tres"
